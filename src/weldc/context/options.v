...
@[footer: 'The compiler expects an input, either file or directory (if directory, it must contain a file entry `src/main.wd`).']
@[xdoc: '\nThe Weld programming language compiler']
@[name: 'weldc']
@[version: '0.1.0']
pub struct Options {
pub mut:
